...
from shared.config import TOP_K, BM25_LARGE_DIR
...
class BM25LargeRetrievalStrategy(RetrievalStrategy):
    def __init__(self):
        self.bm25, self.doc_ids = self._load_artifacts()

    def _load_artifacts(self):
        with open(BM25_LARGE_DIR / "bm25_index.pkl", "rb") as file:
            bm25 = pickle.load(file)

        with open(BM25_LARGE_DIR / "bm25_doc_ids.pkl", "rb") as file:
